...
class round_two :
    ...
    def __init__(self , player_total_score , computer_total_score):
        ...
        def next_round():
            game_window.destroy()
            round_3 = Round_three.round_three(self.player_total_score , self.computer_total_score)

        def play() :
            
            player_round2_score = 0
            computer_round2_score = 0
            ...
            if player_round2_score > computer_round2_score :
                messagebox.showinfo('result' , 'Player wins the round')
                self.player_total_score += 1
            elif computer_round2_score > player_round2_score :
