...
class round_one :
    ...
    def __init__(self):
        ...
        def next_round():
            game_window.destroy()
            round_2 = Round_two.round_two(self.player_total_score , self.computer_total_score)
            

        def play() :
            
            player_round1_score = 0
            computer_round1_score = 0 
            ...
            if player_round1_score > computer_round1_score :
                messagebox.showinfo('result' , 'Player wins the round')
                self.player_total_score += 1
                

            elif computer_round1_score > player_round1_score :
