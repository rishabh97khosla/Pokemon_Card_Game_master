...
class round_three :
    ...
    def __init__(self, player_total_score , computer_total_score):
        ...
        def next_round():
            game_window.destroy()
            round_4 = Round_four.round_four(self.player_total_score , self.computer_total_score)
            

        def play() :
            
            player_round3_score = 0
            computer_round3_score = 0 
            ...
            # round_winner        
            if player_round3_score > computer_round3_score :
                messagebox.showinfo('result' , 'Player wins the round')
                self.player_total_score += 1

            elif computer_round3_score > player_round3_score :
